...
<body>
    <table>
        ...
        <tr>
            ...
            <td><a href="student_edit.php?id=<?php echo $row2->employeeID;?>">Edit</a></td>
            <td><a onclick="return confirm('Are you sure to delete')" href="student_delete.php?id=<?php echo $row2->employeeID;?>">Delete</a></td>
