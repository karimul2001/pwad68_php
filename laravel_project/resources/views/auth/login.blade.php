                        ...
                        <div class="col-12">
                            <form method="post" class="form-horizontal m-t-20" id="loginform" action="{{ route('login') }}">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control form-control-lg" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                ...
                                <div class="form-group text-center">
                                    <div class="col-xs-12 p-b-20">
                                        <button name="submit" class="btn btn-block btn-lg btn-info" type="submit">Log In</button>
                                    </div>
                                </div>
                                <div class="row">
